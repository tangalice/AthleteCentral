...
export default function SessionsManager() {
  ...
  const handleLogoutAll = async () => {
    ...
    if (!window.confirm("Sign out of all sessions? This will log you out on every device.")) return;
    ...
    <div className="container" style={{ paddingTop: 20, paddingBottom: 20 }}>
      ...
      <div className="card" style={{ maxWidth: 720, margin: "0 auto" }}>
        ...
        <p className="text-muted mb-3">
          Manage where your account is signed in. You can search or sign out sessions below.
        </p>

        {/* Search Bar */}
        <input
          type="text"
          placeholder="Search by device name or browser..."
          value={searchTerm}
